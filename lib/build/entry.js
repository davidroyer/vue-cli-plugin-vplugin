...
let VPluginConfig;
if (path.resolve(process.cwd(), "vplugin.config.js")) {
  VPluginConfig = require(path.resolve(process.cwd(), "vplugin.config.js"));
}
console.log("TCL: VPluginConfig", VPluginConfig);
